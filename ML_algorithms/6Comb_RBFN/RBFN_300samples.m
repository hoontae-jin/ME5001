...
X_train = table2array(Traininginput(:,11:220));
y_train = table2array(Trainingoutput(:,11:220));

X_test = table2array(Testinput(:,1:90));
y_test = table2array(Testoutput(:,1:90));
...
% spread = 0.1;
%test
net_test = newrb(X_train_normalized,y_train,goal,1);
view(net_test)
