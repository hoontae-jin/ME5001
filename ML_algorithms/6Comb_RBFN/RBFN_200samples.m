...
X_train = table2array(Traininginput(:,1:140));
y_train = table2array(Trainingoutput(:,1:140));

X_test = table2array(Testinput(:,1:60));
y_test = table2array(Testoutput(:,1:60));
